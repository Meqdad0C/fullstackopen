...
describe('favorite blog', () => {
  ...
  test('when list has one item', () => {
    ...
    expect(listHelper.favoriteBlog([blogs[0]])).toEqual(expectedBlog)
  })
  test('of a bigger list', () => {
    const expectedBlog = {
      title: blogs[2].title,
...
describe('most blogs', () => {
  ...
  test('when list has one item', () => {
    ...
    expect(listHelper.mostBlogs([blogs[0]])).toEqual(expectedAuthor)
  })
  test('of a bigger list', () => {
    const expectedAuthor = {
      author: 'Robert C. Martin',
...
describe('most likes', () => {
  ...
  test('when list has one item', () => {
    ...
    expect(listHelper.mostLikes([blogs[0]])).toEqual(expectedAuthor)
  })
